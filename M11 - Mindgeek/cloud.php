    ...
    <main>
      ...
      <section>
        <article class="cloud">
          ...
          <p class="forfait">299,99$ HT/Mois</p>
          <p class="command"><a href="#">Commander</a></p>
        </article>
        <article class="cloud">
          <p class="title">Cloud EVASION</p>
          <ul>
            <li>Intel e5-16582</li>
            <li>e5 fdg55456</li>
            <li>3,5 sdg ghs e</li>
          ...
          <p class="forfait">489,99$ HT/Mois</p>
          <p class="command"><a href="#">Commander</a></p>
        </article>
        <article class="cloud">
          <p class="title">Cloud LIBERTY</p>
          <ul>
            <li>Intel e5-16582</li>
            <li>e5 fdg55456</li>
            <li>3,5 sdg ghs e</li>
          ...
          <p class="forfait">581,99$ HT/Mois</p>
          <p class="command"><a href="#">Commander</a></p>
        </article>
      </section>
    </main>
